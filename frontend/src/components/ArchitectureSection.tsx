      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto font-mono">
            Discover the intelligent architecture behind MANI X AI's AI-powered
          ...
          <Card className="neon-border bg-card/30 backdrop-blur-sm overflow-hidden hover:shadow-neon-green transition-all duration-500">
            <CardContent className="p-6 md:p-8">
              <LazyAnimatedSVG
                ...
                alt="MANI X AI's AI-powered liquidity management architecture flowchart showing automated processes, risk assessment, yield optimization, and smart contract interactions"
                width={1200}
                height={800}
                className="rounded-lg"
                fallbackText="Loading MANI X AI's architecture diagram..."
              />
