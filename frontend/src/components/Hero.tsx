    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-24 pb-8">
      ...
      <div className="relative z-10 container mx-auto px-4">
        ...
        <div className="text-center animate-slide-up mb-8">
          <div className="mb-6">
            <h1 className="font-terminal text-5xl md:text-7xl lg:text-8xl text-glow-green neon-pulse mb-6">
              MANI X AI
            </h1>
            <div className="flex items-center justify-center gap-2 text-secondary text-lg md:text-xl">
            ...
            <div className="bg-gradient-to-br from-muted/20 to-muted/5 rounded-2xl border border-primary/20 p-6 backdrop-blur-sm">
              ...
              <div className="relative">
                <object
                  ...
                  aria-label="MANI X AI's AI-powered liquidity management architecture flowchart showing automated processes, risk assessment, yield optimization, and smart contract interactions"
                >
                  <img
                    src="/Farouk's Architectures.svg"
                    alt="MANI X AI's AI-powered liquidity management architecture"
