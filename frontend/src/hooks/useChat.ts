  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      ...
      type: "ai",
      content:
        "Welcome to MANI X AI! I'm your AI liquidity manager. I can help you analyze vault performance, optimize your positions, and answer questions about DeFi strategies. How can I assist you today?",
      timestamp: new Date(),
      status: "sent",
    },
  ]);
