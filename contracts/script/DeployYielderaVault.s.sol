...
import "../src/ManiXAIVault.sol"; // adjust path if needed

contract DeployManiXAIVault is Script {
    function run() external {
        ...
        if (isMainnet) {
            ...
            ManiXAIVault vault1 = new ManiXAIVault(
                pool1,
                whbar_address,
            ...
            console.log("ManiXAIVault1 deployed to:", address(vault1));
            ...
            ManiXAIVault vault2 = new ManiXAIVault(
                pool2,
                whbar_address,
                whbar_helper_address,
                saucer_nft_token,
            ...
            console.log("ManiXAIVault2 deployed to:", address(vault2));
